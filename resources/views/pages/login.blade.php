...
<head>
    ...
    <title> Nik R- |Login Register</title>
...
<div class="login-content">
    ...
    <div class="nk-block toggled" id="l-login">
        <div class="nk-form">
            ...
            <a href="#l-register" data-ma-action="nk-login-switch" data-ma-block="#l-register" class="btn btn-login btn-success btn-float"><i class="fa fa-arrow-right"></i></a>
        </div>

        <div class="nk-navigation nk-lg-ic">
            <a href="#" data-ma-action="nk-login-switch" data-ma-block="#l-register"><i class="fa fa-plus"></i> <span>Register</span></a>
    ...
    <div class="nk-block" id="l-register">
        <div class="nk-form">
            ...
            <div class="input-group mg-t-15">
                <span class="input-group-addon nk-ic-st-pro"><i class="fa fa-paper-plane"></i></span>
                <div class="nk-int-st">
            ...
            <a href="#l-login" data-ma-action="nk-login-switch" data-ma-block="#l-login" class="btn btn-login btn-success btn-float"><i class="fa fa-arrow-right"></i> </a>
        </div>

        <div class="nk-navigation rg-ic-stl">
            <a href="#" data-ma-action="nk-login-switch" data-ma-block="#l-login"><i class="fa fa-arrow-left"></i> <span>Sign in</span></a>
            <a href="" data-ma-action="nk-login-switch" data-ma-block="#l-forget-password"><i>?</i> <span>Forgot Password</span></a>
        </div>
    </div>
